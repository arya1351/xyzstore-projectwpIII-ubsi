     ...
     <div class="todo-widget scrollable" style="height:450px;">
      <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
       <li class="list-group-item todo-item" data-role="task">
        <div class="custom-control custom-checkbox">
         ...
         <label class="custom-control-label todo-label" for="customCheck">
          <span class="todo-desc">Lorem Ipsum is simply dummy
           text of the printing and typesetting industry.</span> <span
           class="badge badge-pill badgedanger float-right">Today</span>
         </label>
        </div>
        <ul class="list-style-none assignedto">
         " alt="user" data-toggle="tooltip" data-placement="top"
         title="" data-original-title="Steave">
       </li>
       ...
       <li class="assignee"><img class="rounded-circle" width="40" src="assets/images/users/4.jpg"
         alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
      </ul>
      </li>
      <li class="list-group-item todo-item" data-role="task">
       <div class="custom-control custom-checkbox">
        ...
        <label class="custom-control-label todo-label" for="customCheck1">
         <span class="todo-desc">Lorem Ipsum is simply dummy
          text of the printing</span><span class="badge badge-pill badge-primary float-right">1 week
         </span>
        </label>
       </div>
      ...
      <li class="list-group-item todo-item" data-role="task">
       <div class="custom-control custom-checkbox">
        ...
        <label class="custom-control-label todo-label" for="customCheck3">
         <span class="todo-desc">Lorem Ipsum is simply dummy
          text of the printing </span> <span class="badge badge-pill badge-warning float-right">2
          weeks</span>
        </label>
       </div>
       <div class="item-date"> 26 jun 2017</div>
     ...
     <div>
      ...
      <div class="progress">
       <div class="progress-bar progress-bar-striped bg-success" role="progressbar" style="width: 72%"
        aria-valuenow="25" aria-valuemin="0" ariavaluemax="100"></div>
      </div>
     </div>
     <div>
      <div class="d-flex no-block align-items-center m-t-25">
      ...
      <div class="progress">
       <div class="progress-bar progress-bar-striped bg-info" role="progressbar" style="width: 53%"
        aria-valuenow="50" aria-valuemin="0" ariavaluemax="100"></div>
      </div>
     </div>
     <div>
      <div class="d-flex no-block align-items-center m-t-25">
      ...
      <div class="progress">
       <div class="progress-bar progress-bar-striped bg-danger" role="progressbar" style="width: 3%"
        aria-valuenow="75" aria-valuemin="0" ariavaluemax="100"></div>
      </div>
     </div>
    </div>
   </div>
   ...
   <div class="card">
    ...
    <ul class="list-style-none">
     <li class="d-flex no-block card-body">
      ...
      <div>
       <a href="#" class="m-b-0 p-0 font-medium">Lorem ipsum dolor sit
     ...
     <li class="d-flex no-block card-body border-top">
      ...
      <div>
       <a href="#" class="m-b-0 p-0 font-medium">Congratulation Maruti,
        Happy Birthday</a>
     ...
     <li class="d-flex no-block card-body border-top">
      ...
      <div>
       <a href="#" class="m-b-0 p-0 font-medium">Maruti is a Responsive
        Admin theme</a>
     ...
     <li class="d-flex no-block card-body border-top">
      ...
      <div>
       <a href="#" class="m-b-0 p-0 font-medium">Envato approved Maruti
        Admin template</a>
     ...
     <li class="d-flex no-block card-body border-top">
      ...
      <div>
       <a href="#" class="m-b-0 p-0 font-medium"> I am alwayse here if you
        have any question</a>
       <span class="text-muted">we glad that you choose our
        template</span>
      </div>
      <div class="ml-auto">
       <div class="tetx-right">
  ...
  <div class="col-lg-6">
      ...
      <ul class="chat-list">
       ...
       <li class="chat-item">
        ...
        <div class="chat-content">
         <h6 class="font-medium">James Anderson</h6>
         <div class="box bg-light-info">Lorem Ipsum is simply dummy
       ...
       <li class="odd chat-item">
        <div class="chat-content">
         <div class="box bg-light-inverse">I would love to join the
          team.</div>
         <br>
        </div>
       </li>
       ...
       <li class="odd chat-item">
        <div class="chat-content">
         <div class="box bg-light-inverse">Whats budget of the new
          project.</div>
         <br>
        </div>
       ...
       <li class="chat-item">
        ...
        <div class="chat-content">
         ...
         <div class="box bg-light-info">Well we have good budget for
          the project</div>
        </div>
   ...
   <div class="accordion" id="accordionExample">
    <div class="card m-b-0">
     <div class="card-header" id="headingOne">
      <h5 class="mb-0">
       <a data-toggle="collapse" data-target="#collapseOne" ariaexpanded="true" aria-controls="collapseOne">
    ...
    <div class="card m-b-0 border-top">
     ...
     <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" dataparent="#accordionExample">
      <div class="card-body">
       Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
       terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch.
       Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a
    ...
    <div class="card m-b-0 border-top">
     <div class="card-header" id="headingThree">
      <h5 class="mb-0">
       <a class="collapsed" data-toggle="collapse" datatarget="#collapseThree" aria-expanded="false"
   ...
   <div id="accordian-4">
    <div class="card m-t-30">
     <a class="card-header link" data-toggle="collapse" data-parent="#accordian4" href="#Toggle-1"
     ...
     <div id="Toggle-1" class="show multi-collapse collapse">
     ...
     <a class="card-header link border-top" data-toggle="collapse" dataparent="#accordian-4" href="#Toggle-2"
     ...
     <div id="Toggle-3" class="multi-collapse collapse">
      <div class="card-body widget-content">
       This box is now open
      </div>
     </div>
   ...
   <div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist">
     <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab"><span
        class="hidden-sm-up"></span> <span class="hidden-xsdown">Tab1</span></a> </li>
     ...
     <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#messages" role="tab"><span
        class="hidden-sm-up"></span> <span class="hidden-xsdown">Tab3</span></a> </li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content tabcontent-border">
     <div class="tab-pane active" id="home" role="tabpanel">
      <div class="p-20">
       <p>And is full of waffle to It has multiple paragraphs and is full
        of waffle to pad out the comment. Usually, you just wish these sorts of comments would come
        to an end.multiple paragraphs and is full of waffle to pad out the comment..</p>
     ...
     <div class="tab-pane p-20" id="profile" role="tabpanel">
      <div class="p-20">
       ...
       <p class="m-t-10">And is full of waffle to It has multiple
        paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts
        of comments would come to an end.multiple paragraphs and is full of waffle to pad out the
        comment..</p>
      </div>
     </div>
